...
namespace map2agbgui.Effects
{
    ...
    public class TileEffect : ShaderEffect
    {
        ...
        private static Uri _bytecodePath = new Uri("pack://application:,,,/map2agbgui;component/Effects/TileEffect.ps");
        ...
        public static readonly DependencyProperty SwapPalettesProperty =
         DependencyProperty.Register("SwapPalettes", typeof(float), typeof(TileEffect),
         new UIPropertyMetadata(0f, PixelShaderConstantCallback(6)));
        public float SwapPalettes
        {
            get { return (float)GetValue(SwapPalettesProperty); }
            set { SetValue(SwapPalettesProperty, value); }
        }
        ...
        public TileEffect()
        {
            ...
            UpdateShaderValue(SwapPalettesProperty);
